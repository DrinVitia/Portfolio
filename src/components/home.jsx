    ...
    <div name='home' className='h-screen w-full bg-gradient-to-b from-black via-black to-slate-800 '>
        <div className='text-white max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
            <div className='flex flex-col  justify-center h-full'>
                ...
                <div>
                    <button className='group text-white w-fit px-6 py-3 my-2 flex items-center rounded-md bg-gradient-to-r from-indigo-400 to-blue-500 cursor-pointer'>
                        Portfolio
            ...
            <div>
                <img src={Drin} alt="Profili" className='rounded-full mx-auto
                 w-2/3 md:w-full'/>
            </div>
        </div>
    </div>
